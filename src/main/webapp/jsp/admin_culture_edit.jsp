...
<html>
   ...
   <div>
      ...
      <div class="admin_post">
        ...
        <hr style="border-top: 2px solid #666; width: 90%;">
      <div class="admin_culture_edit_container">
        <form class="" action="updateAdminCulture" method="post">
        <input type="hidden" name="c_post_id" value="${post.c_post_id }">
          <div class="post_title">
            <label class="choose_postOrEvent_label">Title:</label>
            <input type="text" name="c_post_title" value="${post.c_post_title }">
          </div>
          <label class="post_edit_description">Description:</label>
          <textarea style="" name="c_post_des">${post.c_post_des }</textarea>
					<div class="post_submit">
            <input type="submit" name="admin_post_edit_submit" value="UPDATE">
          </div>
          <div class="admin_post_edit_cancel">
            <a href="/demo/jsp/admin_culture">Cancel</a>
          </div>
