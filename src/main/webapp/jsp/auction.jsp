...
<!-- Header -->
    ...
    <div class="arts_bg" id="bg">
     ...
     <a href="/demo/jsp/UserAuctionwinner"> <button class="auction-btn">View History</button></a>
     <div class="auction_winner_announce1">
     	<div class="auction_winner_announce_refresh1">
