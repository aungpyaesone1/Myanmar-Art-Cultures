						...
						<figure>
							<img src="../culture_images/${post.c_post_photo }"/>
								...
								<div class="culture_post_des">
									<p>${post.c_post_des }<a class="culture_post_read_more_link"><label style="cursor:pointer;">View detail...</label></a></p>
								</div>
								...
								<div class="cultural_post_date_contant">28.8.2017</div><br><br>
								<form class="list_item_form" action="delete/${post.c_post_id}" method="get">
