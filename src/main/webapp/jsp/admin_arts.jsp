    ...
    <!-- header -->
                  ...
                  <li>
        						<div class="dropdown" style="left:0%;">
        						 ...
        						 <div class="dropdown-content" style="background-color:#3d557d;Left:0rem;top:3.2rem;">
        							 ...
        							 <a class="active" onclick="art_function()" style="cursor:pointer; font-family:'Times-New-Roman';">Arts</a>
         ...
         <div class="admin-event-culture-post-container">
          ...
          <div class="admin-evnet-culture-post-art-container" id="admin_event_culture_post_culture_art_container_id">
              <label class="admin-event-culture-post-label">Arts</label>
              <div class="admin-event-culture-post-border"></div>
              <div class="admin-event-culture-post-event-container-inner">
               	<div class="art_container" style="border:0px;box-shadow:none;">
              <c:if test="${not empty art}">
			    ...
			    <div class="artist_profile_container">
			      ...
			      <div class="artist_profile_name">
			        <label>${post.first_name }</label>
						...
						<div class="artist_sold_out1">
							<section>
				
			                          
			             <button id="${post.s_id}" data-toggle="modal" data-target="#delete_art_modal" onClick="delete_post_function(this.id)">    
				          <span class="trash">
				          	<span></span>
				          	<i></i>
				          </span>
			    ...
			    <div class="art_img column hover01 hover15">
			      <figure>
			        <img src="../art_images/${post.s_photo }"/>
			      </figure>
			    </div>
...
<!-- Modal -->
		...
		function delete_post_function(_id){
			...
			document.getElementById("delete_form").action="disableArt/"+_id;
		}
		</script>
		<!-- Modal -->
