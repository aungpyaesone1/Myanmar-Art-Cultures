...
<script type="text/javascript" src="http://code.jquery.com/jquery-latest.js"></script>
	...
	<body  style="background-color: #dddddd;">
		...
		<div class="alert alert-danger alert-dismissible custom_alert" id="alert_container">
		  <strong>Error!</strong>${passwordStatus }.
		</div>
		</c:if>
    ...
    <div class="bg" id="bg" style="position:relative;">
              <div id="slideshow">
                   <div>
				     <img src="bagan/bagan11c.jpg" class="slide_img" style=" position: absolute;height:100vh;background-repeat: no-repeat;background-size: cover;background-position: center;">
				   </div>
				   <div>
				    <img src="bagan/bagan5.jpg" class="slide_img" style=" position: absolute;height:100vh;background-repeat: no-repeat;background-size: cover;background-position: center;">
				   </div>
				   <div>
				       <img src="bagan/bagan2.jpg" class="slide_img" style=" position: absolute;height:100vh;background-repeat: no-repeat;background-size: cover;background-position: center;">
				   </div>
				   <div>
				     <img src="bagan/bagan3.jpg" class="slide_img" style=" position: absolute;height:100vh;background-repeat: no-repeat;background-size: cover;background-position: center;">
				   </div>
				</div>
      ...
      <div class="header" id="header">
        ...
        <ul>
          <li><a class="selected" href="/demo/jsp/index" id="nav1">Home</a></li>
			...
			<div id="navPanel" class="navPanel">
				<div class="close_nav">
					...
					<ul class="ph_screen_contant">
						<li class="ph_size_selected"><a href="/demo/jsp/index">Home</a></li>
      ...
      <div class="intro_text">
        <p class="intro_header">Mingalapar!<br>
					<span>LET'S&nbsp; SEE&nbsp;  THE&nbsp;  HERITAGES&nbsp;  OF&nbsp;  MYANMAR&nbsp;  ARTS&nbsp;  AND&nbsp;  CULTURE!</span>
				</p>
		...
		<div class="mycontainer">
			...
			<section id="two">
			 <h3>Latest Posts<hr style="width:200px;border:1px solid #0c2b5d;"></h3>
				<div class="inner">
				<c:if test="${not empty culture}">
                  <c:forEach var="post" items="${culture}">
					<article class="custom">
						<div class="content">
							<header>
								<h3>${post.c_post_title }</h3>
							</header>
							<div class="image fit">
								<div class="hover01 hover15 column wow fadeInUpBig">
                  <figure><img src="../culture_images/${post.c_post_photo }" /></figure>
                </div>
							</div>
							<div  style="margin-left: 2rem; font-size: 17px;">
							<p>${post.c_post_des }</p>
							
							<form class="list_item_form" style="height: 20px;" action="detail/${post.c_post_id}" method="get">
			...
			<c:if test="${not empty employees}">
                  <c:forEach var="post" items="${employees}">
			<div class="container mycontainer_event">
			<div class="top-center">
				<p>${post.e_title }</p>
			</div>
			<div class="middle">
				<h1 style="color: white;">Start Date</h1><hr>
				<p style="font-size: 30px;"> ${post.e_start_date }</p>
			</div>
	...
	<div class="footer">
		<div class="bg_transparent">
          ...
          <ul>
            ...
            <li>
              <a href="#">
								<svg class="facebook_icon" x="0px" y="0px"
									width="50" height="50"
									viewBox="0 0 224 224"
		 	     ...
		 	     <div class="modal-dialog modal-lg">
		           ...
		           <div class="model-body">
                              ...
                              <c:if test="${artist.gender=='female' }">
							            <div data-v-5830c558="" draggable="true" class="app-icon is-color is-custom-size profile-res" style=" fill: rgb(0, 0, 0);margin-top:-2.5rem !important;width:100%;height:100%"><!--?xml version="1.0" encoding="UTF-8"?-->
