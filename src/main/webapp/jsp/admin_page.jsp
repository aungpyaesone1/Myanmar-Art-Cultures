...
<html>
	<head>
        ...
        <script>tinymce.init({ selector:'.copy_textarea' });</script>
        <script src="${pageContext.request.contextPath}/js/multiple_file_upload.js"></script>
	</head>
	<c:if test="${not empty PostSuccessful }">
		<div class="alert alert-success alert-dismissible custom_alert" id="alert_container">
		  <strong>Successfully </strong>${PostSuccessful }
		</div>
   ...
   <div>
      ...
      <div class="admin_page_nav" id="admin_page_nav">
		...
		<div id="nav" class="inner">
	        <ul>
	          <li><a class="active" href="/demo/jsp/adminpost" id="nav1" onclick="post_funtion();">Post</a></li>
	          <li><a href="/demo/jsp/auctionwinner" id="nav2">Winner</a></li>
	             
				<li>
					<div class="dropdown" style="left:0%;">
						<a  id="nav3">Edit</a>
					 <div class="dropdown-content" style="background-color:#3d557d;Left:0rem;top:3.2rem;">
						 <a onclick="event_function()" style="cursor:pointer;">Events</a>
						 <a onclick="culture_function()" style="cursor:pointer;">Cultures</a>
						 <a onclick="art_function()" style="cursor:pointer;">Arts</a>
						  <a onclick="auction_funtion()" style="cursor:pointer; font-family:'Time-News-Roman';">Auction</a>
					 </div>
					</div>
			 	</li>	
			 	<li><a class="admin_logout" id="logout" style="color: #fff;" >Logout</a></li>
	        </ul>
      ...
      <div class="admin_post">
				...
				<div class="choose_postOrEvent">
					<div class="custom-select">
					  <select id="id_of_select_postOrEvent" class="select_content">
					    ...
					    <option value="3" id="bar">Auction</option>
					  </select>
					</div>
				</div>
				...
				<!-- start aution container -->
				<div class="aution_container">
										<form action="multi" name="uploadingForm"  method="post" enctype="multipart/form-data">
						<div class="aution_container_inner_left">
							<div class="post_title">
								<label class="choose_postOrEvent_label">Title:</label>
								<input type="text" name="a_title">
							</div>
							<div class="post_title">
								<label class="choose_postOrEvent_label">Duration:</label>
								<input type="number" min="1" name="a_duration" style="width: 200px; border: 0.5px solid lightgray; border-radius: 3px; height: 30px; padding-left: 1rem;"><span style="margin-left: 4rem;">Days</span>
							</div>
							<div class="post_title">
								<label class="choose_postOrEvent_label">Start Bit:</label>
								<input type="number" min="1" name="a_start_bid" style="width: 200px; border: 0.5px solid lightgray; border-radius: 3px; height: 30px; padding-left: 1rem;"><span style="margin-left: 4rem;">MMK</span>
							</div>
							<!-- <div class="post_title">
								<label class="choose_postOrEvent_label">Choose Photo:</label>
								<div class="controls">
		              <div class="entry input-group col-xs-3 custom_multiple_file_select">
										<input class="btn btn-primary custom_input" name="uploadingFiles" type="file" style="background-image: none;background-color:#2D6C7A;">
		                <span class="input-group-btn">
		              	<button class="btn btn-success btn-add" type="button" style="margin-left: 1rem;">
        ...
        <%-- <div>
            ...
            ${file.getName()}
						...
						<div class="aution_container_inner_right">
							<div class="event_description_box">
								<label class="event_description">Description:</label>
								<textarea class="aution_textarea" name="a_des" placeholder="" style="resize: none; width: 89%; height: 130px;"></textarea>
							</div>
				...
				<div class="event_container">
					<form name="wc-richTextEditor" id="wc-richTextEditor-form" class="wc-richTextEditor" modelAttribute="event" action="store" method="post" enctype="multipart/form-data">
						...
						<div class="event_container_inner_left">
							<div class="post_title">
								<label class="choose_postOrEvent_label" required>  Title: &nbsp; &nbsp;</label>
				...
				<div class="post_container">
					...
					<!--HTML Document Author: Jacob Scott Created: 11-14-15 Modified: 12-16-15	-->
						 ...
						 <div class="wrapper">
							<div class="post_title">
								<label class="choose_postOrEvent_label">  Title: &nbsp; &nbsp;</label>
								<input type="text" name="c_post_title" required="required">
							</div>
							<div class="post_title">
								<input type="hidden" name="email" value="${email }" >
							</div>
							...
							<label class="post_description">Description:</label>
								<textarea style="width: 99%;" name="c_post_des" class="copy_textarea"></textarea>
	 ...
	 $('#myModal').on('hidden.bs.modal', function () {
	   ...
	   element.classList.remove("profile-move-animation");
		...
		<!-- Scripts -->
			...
			<script>
				tinymce.init({ selector:'.copy_textarea, .aution_textarea',branding: false });
	</script>
	</body>
</html>
