    ...
    <div class="culture_bg" id="bg">
      ...
      <div class="culture_intro_text">
		...
		<div class="">
			...
			<div id="culture_container_post">
			<c:if test="${not empty employee}">
             <c:forEach var="post" items="${employee}">
	            
				<div class="culture_post">
					<div class="culture_img figure column hover01 hover15">
						<figure>
			...
			<div class="culture_paginate">
				<c:forEach begin="1" end="${total_page }" varStatus="loop">
				<a class=" paginate_content">
				 <form class="list_item_form" action="pagnition/${loop.index}" method="get">
			          <button class="paginate_content_btn">
			          ${loop.index}
			          </button>
			      </form>
			      </a>
