    ...
    <!-- header -->
              ...
              <div class="admin_page_nav" id="admin_page_nav">
                ...
                <ul>
                  ...
                  <li><a href="/demo/jsp/auctionwinner" style="font-family:'Times-New-Roman';" id="nav2">Winner</a></li>
                  <li>
                    <div class="dropdown" style="left:0%;">
                     ...
                     <div class="dropdown-content" style="background-color:#3d557d;Left:0rem;top:3.2rem;">
                       ...
                       <a class="active" onclick="culture_function()" style="cursor:pointer;  font-family:'Times-New-Roman';">Cultures</a>
                       <a onclick="art_function()" style="cursor:pointer; font-family:'Time-News-Roman';">Arts</a>
         ...
         <div class="admin-event-culture-post-container">
          ...
          <!-- culture -->
          <div class="admin-evnet-culture-post-culture-container" id="admin_event_culture_post_culture_container_id">
              <label class="admin-event-culture-post-label">Cultures</label>
              <div class="admin-event-culture-post-border"></div>
              <div class="admin-event-culture-post-event-container-inner">
                  <div class="culture_container" style="box-shadow:none;" >
                 <!-- culture 1-->
                  <c:if test="${not empty posts}">
                  <c:forEach var="post" items="${posts}">
                 <div class="culture_post">

                   <div class="admin-edit-dropdown" style="right:10%;">
                      <div class="profile-nav-icon" style="opacity:1;">
                      ...
                      <div class="admin-edit-dropdown-content">
                            <!--  <a href="admin_culture_edit.jsp" style="cursor: pointer;">Edit</a>
                             <a>Delete</a> -->
                             <a>
                             <form class="list_item_form" action="edit/${post.c_post_id}" method="get">
								<button class="btn-transparent">Edit</button>
								</form></a>
                              <a class="go_to_profile"  style="color: #636363;">
			                       <label><button class="bg_transparent btn-transparent" id="${post.c_post_id}" data-toggle="modal" data-target="#delete_art_modal" onClick="delete_post_function(this.id)">delete</button></label>
       ...
       <!-- Modal -->
		...
		function delete_post_function(_id){
			document.getElementById("delete_form").action="delete/"+_id;
		}
		</script>
		<!-- Modal -->
