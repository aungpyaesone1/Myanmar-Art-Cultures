          ...
          <c:if test="${empty artist.first_name}">
			...
			<div id="navPanel" class="navPanel">
				...
				<ul class="ph_screen_contant">
					...
					<li class="ph_size_selected"><a href="/demo/jsp/art">Arts</a></li>
					<li><a href="/demo/jsp/culture_page">Culture</a></li>
					<li><a href="/demo/jsp/auction">Auction</a></li>
				</ul>
			</div>
    </div>
 <c:if test="${empty edit_condition}">
<div class="arts_body">
	    <div class="arts_sub_nav">
	      <div class="arts_sub_inner" id="art_paint" style="border-right: 1px solid lightgray;">
	        <span class="arts_sub_type" id="arts_sub_paint" style="color:#4278b2;">Paint</span>
	      </div>
	      <div class="arts_sub_inner" id="art_carving">
	        <span class="arts_sub_type" id="arts_sub_carving">Carving</span>
	      </div>
	    </div>
<!-- paint_start -->
		<div class="paint visible" id="paint_container" style="padding-bottom: 2rem;">
			<div id="load_art_paint_container" class="art_container">
		
			<div id="art_paint_post_container">
			
			<c:import url="art_paint_post.jsp"></c:import>
			</div>

			</div>
			<!-- <div class="paginate_container">
			  <div class="art_paginate">
			    <a class="paginate_content" href="#">&laquo;</a>
			    <a class="paginate_content" href="#">1</a>
			    <a class="paginate_content" href="#">2</a>
...
<!-- paint_end -->
	...
	<div class="carving hide" id="carving_container" style="padding-bottom: 2rem;">
		<div id="load_art_carving_container" class="art_container">
    	<div id="art_carving_post_container">
    	
		<c:import url="art_carving_post.jsp"></c:import>
		</div>
		</div>
		<!-- <div class="paginate_container">
		  <div class="art_paginate">
		...
		<!-- <div class="go_up" id="go_up">
		  ...
		  <c:if test="${not empty artist.first_name}">
		<a href="javascript:" id="artist_post_icon">
			<div data-v-5830c558="" draggable="true" class="app-icon is-win8 is-custom-size" style="width: 20px; height: 20px; fill: #fff;"><!--?xml version="1.0" encoding="UTF-8"?-->
			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 26 26" version="1.1">
			<g id="surface1">
			<path style=" " d="M 17.90625 0 C 17.582031 0 17.246094 0.128906 17 0.375 L 15.5625 1.8125 L 19.15625 5.4375 L 20.625 3.96875 C 21.121094 3.476563 21.125 2.683594 20.625 2.1875 L 18.8125 0.375 C 18.5625 0.125 18.230469 0 17.90625 0 Z M 14.25 2.90625 L 8.40625 8.78125 C 8.332031 8.847656 8.246094 8.929688 8.21875 9.03125 L 6.96875 13.3125 C 6.953125 13.363281 6.9375 13.417969 6.9375 13.46875 C 6.9375 13.609375 6.992188 13.742188 7.09375 13.84375 C 7.230469 13.980469 7.4375 14.023438 7.625 13.96875 L 11.9375 12.71875 C 12.042969 12.6875 12.121094 12.609375 12.1875 12.53125 L 18.03125 6.6875 Z M 1 6 C 0.449219 6 0 6.449219 0 7 L 0 19 C 0 19.550781 0.449219 20 1 20 L 25 20 C 25.550781 20 26 19.550781 26 19 L 26 7 C 26 6.449219 25.550781 6 25 6 L 20.8125 6 L 18.8125 8 L 24 8 L 24 18 L 2 18 L 2 8 L 7 8 L 9 6 Z M 9.1875 9.5625 L 11.03125 9.9375 L 11.40625 11.75 L 8.96875 12.46875 L 8.46875 11.96875 Z "></path>
			</g>
			</svg>
           </div>
		</a>
...
<c:if test="${not empty edit_condition}">
<div class="artist_post_edit_container">
		...
		<div class="artist_profile_container">
			<div class="artist_profile_pic">
				<c:if test="${artist.gender=='female' }">
							            <div data-v-5830c558="" draggable="true" class="app-icon is-color is-custom-size" style="margin-top:5px; fill: rgb(0, 0, 0);display:;"><!--?xml version="1.0" encoding="UTF-8"?-->
										...
										<!-- male profile icon -->
										<div data-v-5830c558="" draggable="true" class="app-icon is-color is-custom-size" style="margin-top:5px; fill: rgb(0, 0, 0);"><!--?xml version="1.0" encoding="UTF-8"?-->
												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 48 48" version="1.1">
												<g id="surface1">
												<path style=" fill:#EDE7F6;" d="M 44 24 C 44 35.046875 35.046875 44 24 44 C 12.953125 44 4 35.046875 4 24 C 4 12.953125 12.953125 4 24 4 C 35.046875 4 44 12.953125 44 24 Z "></path>
   ...
   <form action="editAction" method="post">
     <div class="form-group">
      <input type="text" name="s_title" required="required" value="${editArt.s_title }"/>
    ...
    <input type="hidden" name="s_user_id" value="${editArt.s_user_id }">
		<div class="form-group">
			<input type="text" name="s_material" required="required" value="${editArt.s_material }"/>
		...
		<div class="form-group">
			<input type="number" min="1" name="s_price" required="required" value="${editArt.s_price }"/>
			<label for="input" class="control-label">${editArt.s_price }(MMK)</label><i class="bar"></i>
		</div>
		<div class="form-group">
...
<!-- artist post_upload start -->

<div class="artist_post_upload_container hide">
	<div class="artist_post_upload_inner">
		<div class="artist_profile_container">
			<div class="artist_profile_pic">
		...
		<hr class="post_upload_hr">
			<!--form input type design -->
   <form action="art_post" method="post" enctype="multipart/form-data">
     <div class="form-group">
      <input type="text" name="s_title" required="required"/>
      <label for="input" class="control-label">Title</label><i class="bar"></i>
    </div>

		<div class="form-group">
			<input type="text" name="s_material" required="required"/>
			<label for="input" class="control-label">Medium</label><i class="bar"></i>
		</div>
		<div class="form-group">
	      ...
	      <div class="radio">
	        <label>
	          <input type="radio" name="s_art_id" value="1" checked="checked"/><i class="helper"></i><span style="margin-left: 1rem;">Paint</span>
	        </label>
	      </div>
	      <div class="radio">
	        <label>
	          <input type="radio" name="s_art_id" value="2"/><i class="helper"></i><span style="margin-left: 1rem;">Carving</span>
	        </label>
	      </div>
    	</div>
		</div>
		<div class="form-group">
			<input type="number" min="1" name="s_price" required="required"/>
			<label for="input" class="control-label">Price(MMK)</label><i class="bar"></i>
		</div>
		<input type="hidden" name="s_user_id" value="${artist.user_id }"/>
		<div class="form-group">
			<div class="post_title" style="margin-bottom: -30px;">
								<label class="choose_postOrEvent_label" style="font-size: 15px;">  Upload Photo: &nbsp; &nbsp;</label>
								<label class="upload_input" for="my-file-selector1" required="" style="">
										<input id="my-file-selector1" type="file" name="file" style="display:none" onchange="$('#upload-file-info1').html(this.files[0].name);readURL1(this);event_function1();">
									 <div class="app-icon is-ios7 is-custom-size" style="width: 32px; height: 32px; fill: #888;" draggable="true" data-v-95731366=""><!--?xml version="1.0"?-->
										<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50">
												<path d="M 25 2 C 12.317 2 2 12.317 2 25 s 10.317 23 23 23 s 23 -10.317 23 -23 S 37.683 2 25 2 Z M 37 26 H 26 v 11 h -2 V 26 H 13 v -2 h 11 V 13 h 2 v 11 h 11 V 26 Z"></path>
										</svg>
									 </div>
								...
								<script>
								function event_function1(){
										document.getElementById('blah1').style.opacity=1;
								}
		...
		<div class="form-group">
			<textarea name="s_desc">Next, use our Get Started docs to setup Tiny!</textarea>
	 </div>
	 <div class="form-group artist_post_submit">
		 <a href="/demo/jsp/art">Cancel</a>
		 <input type="submit" name="artist_post_btn" value="Post">
	 </div>
   </form>
	</div>
</div>
...
<!-- artist post_upload end -->
		...
		<div class="bg_transparent">
          ...
          <div class="clear"></div>
			...
			<!-- Modal -->
			<div class="modal fade" id="myModal" role="dialog" style="z-index:999999;top:10rem;" >
...
<!-- Modal -->
		...
		function delete_post_function(_id){
			document.getElementById("delete_form").action="deleteArt/"+_id;
		}
		</script>
