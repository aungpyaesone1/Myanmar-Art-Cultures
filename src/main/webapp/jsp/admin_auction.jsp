...
<html>
  ...
  <body class="overflow:hidden;" onload="codeAddress();">
    <!-- header -->
              ...
              <div class="admin_page_nav" id="admin_page_nav">
                ...
                <ul>
                  ...
                  <li><a href="/demo/jsp/auctionwinner" id="nav2" style="font-family:'Times-New-Roman';">Winner</a></li>
                  <li>
    ...
    <c:forEach var="post" items="${auctions}">
			<div class="auction_container_inner">
				...
				<div class="auction_container_inner_right">
					...
					<form class="list_item_form" action="toAuction/${post.a_post_id}" method="get">
					<span style="font-family: Poppins-Medium;font-size: 15px;color: #363636;">StartBid: ${post.a_start_bid } MMK</span>
			           <button>CHECK!</button>
			         </form>
    ...
    <c:forEach var="post" items="${auctions}">		
			...
			<div class="auction_container_inner">
				<div class="admin-edit-dropdown" style="z-index:99999 !important;">
                     <div class="profile-nav-icon">
                      <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 24 24" style="fill:gray; position:absolute;">
                     ...
                     <a>
                             <form class="list_item_form" action="auction_edit/${post.a_post_id}" method="get">
								<button class="btn-transparent">Edit</button>
								</form>
					</a>
                            <a>
                            <button class="bg_transparent btn-transparent" id="${post.a_post_id }" data-toggle="modal" data-target="#delete_art_modal" onClick="delete_post_function(this.id)">delete</button>
			                 </a>
                     </div>
                 </div>
				<div class="auction_container_inner_left  column hover01 hover15">
...
<!-- Modal -->
		...
		function delete_post_function(_id){
			...
			document.getElementById("delete_form").action="deleteAuction/"+_id;
		}
		</script>
		<!-- Modal -->
