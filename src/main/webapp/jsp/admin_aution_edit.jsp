    ...
    <!-- header -->
              ...
              <li>
    						<div class="dropdown" style="left:0%;">
    						 ...
    						 <div class="dropdown-content active" style="background-color:#3d557d;Left:0rem;top:3.2rem;">
    							 ...
    							 <a class="active" onclick="auction_funtion()" style="cursor:pointer; font-family:'Time-News-Roman';">Auction</a>
    						 </div>
    						</div>
    				 </li>
         ...
         <div class="admin-event-culture-post-container">
          ...
          <div class="admin-evnet-culture-post-event-container" id="admin_event_culture_post_event_container_id">
              <label class="admin-event-culture-post-label">Auction</label>
              <div class="admin-event-culture-post-border"></div>
				<!-- start aution edit -->
              	<div class="aution_container aution_edit">
					<form action="editAuctionFromAdmin" method="post">
						<div class="aution_container_inner_left">
							<div class="post_title">
								...
								<input type="text" value="${auction.a_title }" name="a_title">
							</div>
							<div class="post_title">
								<label class="choose_postOrEvent_label">Duration:</label>
								<input type="number" min="1" name="a_duration" value="${auction.a_duration }" style="width: 200px; border: 0.5px solid lightgray; border-radius: 3px; height: 30px; padding-left: 1rem;"><span style="margin-left: 4rem;">Days</span>
							</div>
							<div class="post_title">
								<label class="choose_postOrEvent_label">Start Bid:</label>
								<input type="number" min="1" name="a_start_bid" value="${auction.a_start_bid }" style="width: 200px; border: 0.5px solid lightgray; border-radius: 3px; height: 30px; padding-left: 1rem;"><span style="margin-left: 4rem;">MMK</span>
							</div>
						...
						<div class="aution_container_inner_right">
							<div class="event_description_box">
								...
								<textarea class="aution_textarea" name="a_des" value="" placeholder="" style="resize: none; width: 89%; height: 130px;">${auction.a_des }</textarea>
							</div>
							<div class="event_submit">
								<input type="submit" name="aution_edit_submit" value="UPDATE">
							</div>
						</div>
					</form>
				</div>
