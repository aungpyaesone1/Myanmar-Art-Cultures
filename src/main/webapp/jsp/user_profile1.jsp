		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
						 <div class="no-user-contacts-div">
							...
							<label class="no-user-contacts-label">${artist1.phone_no }</label>
						</div>
						<div class="no-user-contacts-div">
						 <label class="no-user-contacts-title">Email:</label>
						 <label class="no-user-contacts-label">${artist1.email }</label>
					 </div>
					 <div class="no-user-contacts-div">
						<label class="no-user-contacts-title">Address:</label>
						<label class="no-user-contacts-label">${artist1.address }</label>
					</div>
		      </div>
		    </div>
								 ...
								 <c:if test="${artist1.gender=='female' }">
									...
									<div class="profile-container" id="profile-cotainer-id">
										 <div class="profile-container-inner">
											 <div class="profile-content">
												 ...
												 <label class="profile-label label-fade-in">${artist1.first_name }</label>
										 </div>
									 ...
									 <div class="profile-content">
										 ...
										 <label class="profile-label label-fade-in">${artist1.email }</label>
									</div>
										 ...
										 <div class="profile-content">
											 ...
											 <label class="profile-label label-fade-in">${artist1.phone_no }</label>
									 </div>
									</div>
									...
									<div class="profile-container-inner profile-extra">
										...
										<div class="profile-content">
														 ...
														 <label class="profile-label label-fade-in">${artist1.gender }</label>
												 </div>
									<div class="profile-content">
									 ...
									 <label class="profile-label label-fade-in">${artist1.address }</label>
									</div>
									</div>
    ...
    <a href="/demo/jsp/index">
     ...
     <div data-v-5830c558="" draggable="true" class="app-icon is-androidL is-custom-size" style="width: 28px; height: 28px; fill: #fff;margin:3px;"><!--?xml version="1.0"?-->
      ...
      <div class="user-profile-image" id="user_profile_image">
           <!--  <img src="images/profile.jpg" class="user-profile-res">-->
      ...
      <!-- profile name-->
          <label class="user-profile-name-label" id="user_profile_name_label"> ${artist1.first_name }</label>
       ...
       <div class="user-profile-address-container" id="user_profile_address_cotainer">
           ...
           <div class="user-profile-lable-cotainer phone-container">
             <div data-v-5830c558="" class="user-profile-icon-div" draggable="true" class="app-icon is-Dusk_Wired is-custom-size" style="width: 30px; height: 30px; fill: #fff;">
              ...
              <label class="user-profile-label">${artist1.phone_no }</label>
           </div>
           <!--email -->
           <div class="user-profile-lable-cotainer email-container">
             <div data-v-5830c558="" class="user-profile-icon-div" draggable="true" class="app-icon is-Dusk_Wired is-custom-size" style="width: 30px; height: 30px; fill: #fff;">
              ...
              <label class="user-profile-label">${artist1.email }</label>
           </div>
           <!--address-->
           <div class="user-profile-lable-cotainer address-container">
             <div data-v-5830c558="" class="user-profile-icon-div" draggable="true" class="app-icon is-Dusk_Wired is-custom-size" style="width: 30px; height: 30px; fill: #fff;">
              ...
              <label class="user-profile-label">${artist1.address }</label>
           </div>
					 <!-- view more no user-->
					 <div class="user-profile-lable-cotainer no-user-profile-view-more-container" data-toggle="modal" data-target="#mycontactModal" style="">
						 <div data-v-5830c558="" class="user-profile-icon-div" draggable="true" class="app-icon is-Dusk_Wired is-custom-size" style="width: 30px; height: 30px; fill: #fff; filter:blur(0.5px);">
							...
							<a class="user-profile-label-ahre" >Contact Me</a>
					 </div>
						        ...
						        <label>${post.first_name }</label>
									...
									<div class="artist_sold_out1_for_k">
										<div class="admin-edit-dropdown" style="right:4rem;">
											 ...
											 <c:if test="${artist.first_name==post.first_name}">
